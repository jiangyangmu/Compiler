...
$str1 DB 25H,66H,20H,3dH,20H,25H,66H,0aH,00H ; "%f = %f\n"
CONST ENDS
_DATA SEGMENT
$sp0 DQ $str0
$sp1 DQ $str1
_DATA ENDS
_BSS SEGMENT
bssi8 QWORD 00000000000000001h DUP (?)
bssi4 DWORD 00000000000000001h DUP (?)
_BSS ENDS
...
ASMPrintf PROC
    mov rcx, QWORD PTR $sp1
    movsd xmm1, QWORD PTR __real@3ff0000000000000
    mov rdx, QWORD PTR __real@3ff0000000000000
    movsd xmm2, QWORD PTR __real@3ff0000000000000
    mov r8, QWORD PTR __real@3ff0000000000000
    call printf
    ret
ASMPrintf ENDP
